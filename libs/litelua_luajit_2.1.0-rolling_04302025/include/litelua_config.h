...
// Include Lua or LuaJIT headers
    ...
    #define LITELUA_LUA_CORE <lua.h>        // Change the path to Lua/LuaJIT lua.h
    #endif

    #ifndef LITELUA_LUA_LIBS
    #define LITELUA_LUA_LIBS <lualib.h>     // Change the path to Lua/LuaJIT lualib.h
    #endif

    #ifndef LITELUA_LUA_XLIBS
    #define LITELUA_LUA_XLIBS <lauxlib.h>   // Change the path to Lua/LuaJIT lauxlib.h
    #endif
