...
function View:on_mouse_pressed(button, x, y, clicks)
    if button == "left" and self:scrollbar_overlaps_point(x, y) then
...
function View:update()
    ...
    self:move_towards(self.scroll, "x", self.scroll.to.x, 0.35)
    self:move_towards(self.scroll, "y", self.scroll.to.y, 0.35)
end
...
function View:draw()
    -- no-ops, require child class's definition
end
